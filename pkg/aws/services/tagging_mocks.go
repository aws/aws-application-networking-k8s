...
func (m *MockTagging) UpdateTags(arg0 context.Context, arg1 string, arg2, arg3 map[string]*string) error {
	m.ctrl.T.Helper()
...
func (mr *MockTaggingMockRecorder) UpdateTags(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateTags", reflect.TypeOf((*MockTagging)(nil).UpdateTags), arg0, arg1, arg2, arg3)
}
