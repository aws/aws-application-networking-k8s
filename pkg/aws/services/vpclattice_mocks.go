...
// MockLatticeServiceNameProvider is a mock of LatticeServiceNameProvider interface.
type MockLatticeServiceNameProvider struct {
	ctrl     *gomock.Controller
	recorder *MockLatticeServiceNameProviderMockRecorder
}

// MockLatticeServiceNameProviderMockRecorder is the mock recorder for MockLatticeServiceNameProvider.
type MockLatticeServiceNameProviderMockRecorder struct {
	mock *MockLatticeServiceNameProvider
}

// NewMockLatticeServiceNameProvider creates a new mock instance.
func NewMockLatticeServiceNameProvider(ctrl *gomock.Controller) *MockLatticeServiceNameProvider {
	mock := &MockLatticeServiceNameProvider{ctrl: ctrl}
	mock.recorder = &MockLatticeServiceNameProviderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockLatticeServiceNameProvider) EXPECT() *MockLatticeServiceNameProviderMockRecorder {
	return m.recorder
}

// LatticeServiceName mocks base method.
func (m *MockLatticeServiceNameProvider) LatticeServiceName() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LatticeServiceName")
	ret0, _ := ret[0].(string)
	return ret0
}

// LatticeServiceName indicates an expected call of LatticeServiceName.
func (mr *MockLatticeServiceNameProviderMockRecorder) LatticeServiceName() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LatticeServiceName", reflect.TypeOf((*MockLatticeServiceNameProvider)(nil).LatticeServiceName))
}
...
func (m *MockLattice) FindService(ctx context.Context, nameProvider LatticeServiceNameProvider) (*vpclattice.ServiceSummary, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindService", ctx, nameProvider)
...
func (mr *MockLatticeMockRecorder) FindService(ctx, nameProvider interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindService", reflect.TypeOf((*MockLattice)(nil).FindService), ctx, nameProvider)
}

// FindServiceNetwork mocks base method.
func (m *MockLattice) FindServiceNetwork(ctx context.Context, name, accountId string) (*ServiceNetworkInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindServiceNetwork", ctx, name, accountId)
...
func (mr *MockLatticeMockRecorder) FindServiceNetwork(ctx, name, accountId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindServiceNetwork", reflect.TypeOf((*MockLattice)(nil).FindServiceNetwork), ctx, name, accountId)
}
