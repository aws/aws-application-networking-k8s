...
func (mr *MockLatticeMockRecorder) FindService(ctx, latticeServiceName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLatticeMockRecorder) GetRulesAsList(ctx, input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLatticeMockRecorder) ListRulesAsList(ctx, input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
