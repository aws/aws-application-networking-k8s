...
type ACM interface {
	...
	DescribeCertificate(ctx context.Context, input *acm.DescribeCertificateInput) (*acm.DescribeCertificateOutput, error)
}
...
func (d *defaultACM) DescribeCertificate(ctx context.Context, input *acm.DescribeCertificateInput) (*acm.DescribeCertificateOutput, error) {
	return d.client.DescribeCertificateWithContext(ctx, input)
}
