...
`Gateway` allows you to configure network traffic through the AWS VPC Lattice Gateway API Controller.
...
and use the resource within the AWS VPC Lattice Gateway API Controller project. For in-depth details and specifications, you can refer to the
